...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page"><a class="banner banner-top" href="https://www.templatemonster.com/website-templates/monstroid2.html" target="_blank"><img src="images/monstroid.jpg" alt="" height="0"></a>
      ...
      </section><a class="banner" href="https://www.templatemonster.com/website-templates/monstroid2.html" target="_blank"></a>
        ...
        <div class="footer-inner-1">
          <div class="container">
            <div class="row row-40">
              ...
              <div class="offset-lg-0 col-lg-4 col-md-3">
                <h5>Heures de fonctionnement</h5>
                <div class="row row-5 justify-content-between">
<div class="col-sm-4 col-xxl-5 col-lg-12 col-md-12">
                <ul class="footer-list big">
                      <li><a href="#">Samedi - Jeudi 8:30 à 12:00 et 13:00 à 16:30</a></li>
                    </ul>
                  </div>
                </div>
              </div>
